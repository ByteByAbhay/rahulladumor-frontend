...
export default function ServerlessApplicationDevelopmentPage({ profileData }) {
  const serviceData = servicePages["serverless-application-development"];

  // Merge page-specific SEO with global verification codes
  const seo = {
    ...pageSEO.serverlessApplicationDevelopment,
