...
export default function DataEngineeringMlopsConsultingPage({ profileData }) {
  const serviceData = servicePages["data-engineering-mlops-consulting"];

  // Merge page-specific SEO with global verification codes
  const seo = {
    ...pageSEO.dataEngineeringMlopsConsulting,
