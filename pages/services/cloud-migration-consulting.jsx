...
export default function CloudMigrationConsultingPage({ profileData }) {
  const serviceData = servicePages["cloud-migration-consulting"];

  // Merge page-specific SEO with global verification codes
  const seo = {
    ...pageSEO.cloudMigrationConsulting,
