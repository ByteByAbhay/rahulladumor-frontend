...
export default function AiPoweredCloudOptimizationPage({ profileData }) {
  const serviceData = servicePages["ai-powered-cloud-optimization"];

  // Merge page-specific SEO with global verification codes
  const seo = {
    ...pageSEO.aiPoweredCloudOptimization,
