...
export default function AwsCloudArchitectureReviewPage({ profileData }) {
  const serviceData = servicePages["aws-cloud-architecture-review"];

  // Merge page-specific SEO with global verification codes
  const seo = {
    ...pageSEO.awsCloudArchitectureReview,
